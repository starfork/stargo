...
import (
	...
	mysqlscope "github.com/starfork/stargo/store/mysql"
	"github.com/starfork/stargo/store/mysql/uid"
...
func (h *handler) CreateUser(ctx context.Context, req *pb.CreateUserRequest) (*pb.CreateUserResponse, error) {
	...
	// 使用 time.Now() 创建时间戳 (生产环境建议使用 store.Now() 获取 Shanghai 时区时间)
	// Use time.Now() for timestamp (in production, prefer store.Now() for Shanghai timezone)
